...
export default function Home() {
  return (
    <div className="relative lg:px-36 2xl:px-80 px-5 pt-48 bg-gray-700">
      <img src={Hina} className="opacity-30" />
      <h1 className="text-5xl font-bold text-[#ff2c2c]">DETERMINIX</h1>
