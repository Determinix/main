...
export default function Footer() {
  return (
    <footer className="justify-between bg-slate-900 text-white py-24 lg:text-center">
      <div className="grid grid-cols-4 gap-2 mx-auto">
        <a>
          <img src={DXlogo1} className="w-11 mx-48" />
        </a>
        <h1 className="text-xs">Copyright 2023 create by Determinix agent</h1>
        <h1 className="text-xs">Copyright 2023 create by Determinix agent</h1>
        <h1 className="text-xs">Copyright 2023 create by Determinix agent</h1>
      </div>
