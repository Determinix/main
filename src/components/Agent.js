  ...
  return (
    <div className="lg:mx-40 pb-32 pt-24">
      ...
      <div className="grid sm:grid-cols-4 grid-cols-1 gap-6 place-items-center">
        <a href="https://www.instagram.com/difhaels/?hl=id" target={"_blank"} className="w-[285px] h-[125px] shadow-2xl bg-slate-200 hover:bg-slate-100 -ml-16">
        ...
        <a className="w-[285px] h-[125px] shadow-2xl  bg-slate-200 hover:bg-slate-100 -ml-16">
          <div className="flex items-center justify-between p-3">
            <img alt="???" className="w-[100px] h-[100px]" />
            <div>
